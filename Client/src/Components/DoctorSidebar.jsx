        ...
        <>
            <div className={`h-full px-2 py-5 bg-white dark:bg-slate-700 shadow-lg  shadow-gray-500 dark:shadow-none ${menuOpen ? 'w-[35vh] absolute md:relative' : 'w-[10vh]'}`}>
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/DoctorDashboard" className="flex flex-row items-center">
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/" className="flex flex-row items-center">
                        ...
                        <span className={`px-4 text-md font-bold text-black hover:text-violet-600 dark:text-white dark:hover:text-violet-600 ${menuOpen ? 'block' : 'hidden'}`}>Patient Record</span>
                    </a>
                </div>
                <div className="p-2 w-full overflow-hidden">
                    <a href="/" className="flex flex-row items-center">
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/" className="flex flex-row items-center">
                        ...
                        <span className={`px-4 text-md font-bold text-black hover:text-violet-600 dark:text-white dark:hover:text-violet-600 ${menuOpen ? 'block' : 'hidden'}`}>Medical Result</span>
                    </a>
                </div>
                <div className="p-2 w-full overflow-hidden">
                    <a href="/" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
                            <path fill="currentColor" d="M4.5 8.552c0 1.995 1.505 3.5 3.5 3.5s3.5-1.505 3.5-3.5-1.505-3.5-3.5-3.5-3.5 1.505-3.5 3.5zM19 8h-2v3h-3v2h3v3h2v-3h3v-2h-3zM4 19h10v-1c0-2.757-2.243-5-5-5H7c-2.757 0-5 2.243-5 5v1h2z"/>
                        </svg>
                        <span className={`px-4 text-md font-bold text-black hover:text-violet-600 dark:text-white dark:hover:text-violet-600 ${menuOpen ? 'block' : 'hidden'}`}>View Patients</span>
                    </a>
                </div>
                <div className="p-2 w-full overflow-hidden">
                    <a href="/" className="flex flex-row items-center">
                ...
                <div className="p-2 w-full flex flex-row items-center overflow-hidden">
                    {colorTheme === "light" ? (
                        ...
                        <span className={`px-4 text-md font-bold text-black dark:text-white ${menuOpen ? 'block' : 'hidden'}`}>Theme</span>
                </div>
                <div className="p-2 w-full overflow-hidden">
                    <a href="/DoctorProfile" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
                        ...
                        <span className={`px-4 text-md font-bold text-black dark:text-white ${menuOpen ? 'block' : 'hidden'}`}>Profile</span>
                    </a>
                </div>
                <div className="p-2 w-full overflow-hidden">
                    <a href="/DoctorLogOut" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
                            <path fill="currentColor" d="M18 2H6a1 1 0 0 0-1 1v9l5-4v3h6v2h-6v3l-5-4v9a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V3a1 1 0 0 0-1-1z"/>
                        </svg>
                        <span className={`px-4 text-md font-bold text-black dark:text-white ${menuOpen ? 'block' : 'hidden'}`}>Log Out</span>
                    </a>
                </div>
            </div>
        </>

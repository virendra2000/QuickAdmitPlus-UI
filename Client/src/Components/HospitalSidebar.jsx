...
const HospitalSidebar = () => {
    ...
    return (
        <>
            <div className={`h-[100%] px-2 py-5 bg-white dark:bg-slate-700 shadow-lg  shadow-gray-500 dark:shadow-none ${menuOpen ? 'w-[35vh] absolute md:relative' : 'w-[10vh]'}`}>
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/HospitalDashboard" className="flex flex-row items-center">
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/AdmitPatient" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
                            <path fill="currentColor" d="M15 2.013H9V9H2v6h7v6.987h6V15h7V9h-7z"/>
                        </svg>
                        <span className={`px-4 text-md font-bold text-black hover:text-violet-600 dark:text-white dark:hover:text-violet-600 ${menuOpen ? 'block' : 'hidden'}`}>Admit Patients</span>
                    </a>
                </div>
                <div className="p-2 w-full overflow-hidden">
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/HospitalProfile" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
                ...
                <div className="p-2 w-full overflow-hidden">
                    <a href="/HospitalLogOut" className="flex flex-row items-center">
                        <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" className="text-violet-600 dark:text-slate-500 cursor-pointer">
